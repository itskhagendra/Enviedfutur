    ...
    <>
        ...
        <Container fluid >
            <Row className='JumoContainer' style={{height:"100vh"}}>
                <Col>
                    <img src='Images/Model.png' style={{height:"80%",width:'auto', margin:'15% 20%'}}/>
                </Col>
                <Col style={{padding:'2% 10%'}}>
                    <div>
                        <img src='Images/LogoFullText.jpg' style={{width:'40%',align:'right',marginLeft:'20vw',paddingBottom:'20px'}}/>
